...
if user_menu == 'Medal Tally':
    ...
    if selected_country != 'Overall' and selected_country != 'Overall':
        st.title(selected_country + " performance in " + str(selected_country) + " Olympics")
...
if user_menu == 'Overall Analysis':
    ...
    fig.update_layout(title="Events over the years")
...
if user_menu == 'Country-wise Analysis':
    ...
    # Inside helper.py, you could create a filtered list:
    country_list = df[df['Medal'].notnull()]['region'].dropna().unique().tolist()
